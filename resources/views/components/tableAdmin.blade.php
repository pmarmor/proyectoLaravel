...
<table>
    <tr><th>Nombre</th><th>Nombre de usuario</th><th>Correo</th><th>Correo verificado</th>
        <th>Administrador</th><th>Fecha de creación</th><th>Última actualización</th><th>Sancionado hasta</th><th colspan="2">Acciones</th></tr>
    @foreach($usuarios as $usuario)
        ...
        <tr class="userPaginationRow" id="{{$usuario->id}}" >
            ...
            <td>{{$admin}}</td><td>{{$usuario->created_at}}</td><td>{{$usuario->updated_at}}</td><td>{{$usuario->bannedAccount}}</td>
